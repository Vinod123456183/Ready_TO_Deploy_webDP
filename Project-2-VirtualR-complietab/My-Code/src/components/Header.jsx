...
import { navItems } from "../constants"; // Ensure navItems is correctly structured
...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 py-3 backdrop-blur-lg p-4 border-b border-neutral-700/80 max-w-[2560px] ">
      <div className="container px-4 mx-auto relative lg:text-sm">
        <div className="flex justify-between items-center">
          <div className="flex items-center flex-shrink-0">
            <img className="h-10 w-10 mr-2" src={logo} alt="Logo" /> {/* Ensure the logo path is correct */}
